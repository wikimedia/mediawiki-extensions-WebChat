...
$messages['de'] = array(
	'webchat' => 'Web-Chat',
	'webchat-desc' => 'Ermöglicht über eine [[Special:WebChat|Spezialseite]] in Echtzeit mit anderen Benutzern zu chatten',
...
$messages['fa'] = array(
	'webchat' => 'گفتگوی وب',
	'webchat-desc' => 'افزودن یک [[Special:WebChat|صفحه ویژه]]  برای گفتگو در زمان واقعی با دیگر کاربران ویکی مورد استفاده قرار گرفت',
	'webchat-header' => 'این صفحهٔ خاص به شما برای همکاری در زمان واقعی با دیگر کاربران ویکی، اجازه می‌دهد.
برای اتصال به سادگی دکمهٔ «اتصال» را فشار دهید.
اگر شما وارد سامانه هستید، نام مستعار شما از قبل پر خواهد‌شد.
کاربران ناشناس به صورت خودکار تولید داده شده‌اند، اما این می‌توان تغییر کند.',
...
$messages['ja'] = array(
	...
	'webchat-header' => 'この特別ページを使うと、このウィキの他の利用者とリアルタイムで共同作業ができるようになります。
「接続」ボタンを押すだけで接続できます。
ニックネームでログインしている場合は、その名前があらかじめ入力されています。
匿名の利用者には、自動的に名前が付けられますが変更することもできます。',
...
На анонимните корисници им се доделува автоматски создаден прекар, но тој може да се промени.',
	'right-webchat' => 'Дозволено користење [[Special:WebChat|Семрежни разговори (web chat)]]',
);
...
$messages['ru'] = array(
	...
	'webchat-header' => 'Эта служебная страница позволяет в реальном времени совместно обсуждать что-либо с другими участниками вики.
Для соединения просто нажмите кнопку «Connect».
Если вы авторизованы, то здесь будет указано имя вашей учётной записи.
Не представившиеся участники получают автоматически создаваемое имя, которое можно изменить.',
...
$messages['sr-ec'] = array(
	...
	'webchat-header' => "Ова посебна страница омогућава вам да се дописујете у реалном времену с осталим корисницима викија.
...
Upang makakunekta pindutin lang ang pindutang "Kumunekta".
